  ...
  return (
    <main>
      <section class="bg-gray-100 min-h-screen flex box-border justify-center items-center">
        <div class="rounded-2xl flex max-w-3xl p-5 items-center w-full">
          <div class="md:w-1/2 px-8 mr-10 ">
            ...
            <div class="mt-4 text-sm flex justify-between items-center container-mr">
              <p class="mr-3 md:mr-0 ">Don't have account yet?</p>
              <a href="" className="text-blue-600">
                Register
              </a>
            </div>
            <div class="mt-6 items-center text-gray-500">
            ...
            <button
              type="submit"
              class="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 hover:bg-[#60a8bc4f] font-medium mb-5"
            >
              <svg
                class="mr-3"
                xmlns="http://www.w3.org/2000/svg"
